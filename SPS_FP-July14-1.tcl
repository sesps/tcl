#  SpecTclGUI save file created Fri Jul 13 10:53:51 EDT 2018
...
pseudo sps-X-diff {adc1.00 adc1.09} { return [expr (${adc1.00}>10 && ${adc1.00}<3800 && ${adc1.09}<3800 && ${adc1.09}>10) ? (${adc1.00} - ${adc1.09}) : -500 ]}
...
catch {spectrum -delete sps-BX-diff}
spectrum sps-BX-diff 2 {adc1.00 sps-X-diff} {{0.000000 4095.000000 1024} {0.000000 4095.000000 1024}} long
catch {spectrum -delete sps-X-diff}
spectrum sps-X-diff 1 sps-X-diff {{0.000000 4095.000000 4095}} long
